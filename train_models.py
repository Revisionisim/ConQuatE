...
parser.add_argument("--number", default='0', help="times of run")
args = parser.parse_args()

if args.model_name is None or len(args.model_name.strip()) == 0:
    args.model_name = "{}_number{}_lda-{}_nneg-{}_hs-{}_lr-{}_nepochs-{}".format(
                                                                        args.model,
                                                                        args.dataset,
                                                                        args.train_times,
                                                                        args.nbatches,
...
# prediction mode
    ...
    if args.model == "RQE":
        ...
        con.set_test_model(HRQDE, result_dir+'/'+args.model+'.ckpt')    
    elif args.model == "QuatE":
