...
class Config(object):
    def __init__(self):
        ...
        """restype"""
        self.lib.getValidHit.restype = ctypes.c_float
    ...
    def train(self):
        ...
        for epoch in range(self.train_times):
            ...
            if (epoch + 1) % self.valid_steps == 0:
                ...
                hit1,hit3,hit10 = self.valid(self.trainModel)
                print("hit@1 of valid set is %f\n" % (hit1))
                print("hit@3 of valid set is %f\n" % (hit3))
                print("hit@10 of valid set is %f\n" % (hit10))
                if hit10 > best_hit10:
                    best_hit10 = hit10
                    best_epoch = epoch
